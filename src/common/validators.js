export default {
  ...
  mobile: function (value) {
    ...
    //http://miinac.gov.cn/  电信网码号资源使用审批结果（公众移动通信网号段）_截至2018年10月31日.pdf
    //物联网 141,144
    // matcher: /^((13[0-9])|(14[5-9])|(15[0-3,5-9])|(16[2,5-7])|(17[0-9])|(18[0-9])|(19[1,8-9]))\d{8}$/
    return (/^((13[0-9])|(14[5-9])|(15[0-3,5-9])|(16[2,5-7])|(17[0-9])|(18[0-9])|(19[1,8-9]))\d{8}$/).test(value)
  },
